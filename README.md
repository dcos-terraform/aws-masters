...
| aws_instance_type | Specify the instance type | string | `m4.xlarge` | no |
...
| num_masters | The Number of masters to spawn. This number should be odd. Typical options are (1,3,5,7,9) | string | `3` | no |
